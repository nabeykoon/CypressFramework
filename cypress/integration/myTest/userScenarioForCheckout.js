...
import { PurchasePage } from '../pageObjects/PurshasePage';
import { Homepage } from '../pageObjects/HomePage';

//Import utilities
import { sumOfProducts } from '../utils/util'
import { finalTotal } from '../utils/util'
...
describe('Home page Test suite', () => {
    ...
    it('My first test case', function () {
        ...
        (async function verifyProductTotals() {
            var sum = await sumOfProducts();
            var total = await finalTotal();
            expect(sum).to.equal(total);
        })();

        //get sum of products using page object method
